...
const View_2 = () => {
	return(
		<div class={style.wrapper}>
			...
			<div className='d-flex flex-column flex-1 justify-items-center bg-offshade'>
			...
			<div className='d-flex flex-column flex-1 align-self-center justify-content-start p-20 m-top-20'>
				...
				<span className='d-flex flex-row'>
					<span className='p-5 text-md text-accent'><AiOutlineConsoleSql /></span>
					<span className='p-5 text-md text-accent'><SiMongodb /></span>
					<span className='p-5 text-md text-accent'><SiDotnet /></span>
					<span className='p-5 text-md text-accent'><SiDocker /></span>
				</span>                      
	...
	return(
		<div class={style.wrapper}>
			<div className='d-flex flex-column flex-1 align-self-center justify-content-end p-20 m-v-20'>
				...
				<span className='d-flex flex-row align-self-end'>
					<span className='p-5 text-md text-accent'><SiJavascript /></span>
					<span className='p-5 text-md text-accent'><SiReact /></span>
					<span className='p-5 text-md text-accent'><SiSass /></span>
				</span>
...
const Footer = () => {
	return(
		<div className='d-flex bg-accent p-v-50 p-20' style={{minHeight: "15vh"}} >
			<div className='d-flex flex-1 justify-content-center align-items-center'>
				...
				<span><img src={Icon} alt="TM Logo" height='25px' width='25px' /></span>
